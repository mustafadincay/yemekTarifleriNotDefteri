package com.mustafadincay.yemektariflerim
...
class TarifFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            if (gelenBilgi.equals("menudengeldim")) {
                ...
                val gorselSecmeArkaPlani = BitmapFactory.decodeResource(context?.resources, R.drawable.secimgorseli)
                ...
                context?.let {
                    try {
                        ...
                        val yemekTarifIndex = cursor.getColumnIndex("yemektarifi")
                        ...
                        while (cursor.moveToNext()){
                            ...
                            yemekTarifiText.setText(cursor.getString(yemekTarifIndex))
    ...
    fun kaydet(view: View){
        ...
        val yemekTarif = yemekTarifiText.text.toString()
        ...
        if (secilenBitmap != null) {
            ...
            try {
                context?.let {
                    ...
                    val sqlString = "INSERT INTO yemekler (yemekismi, yemekmalzemesi, yemektarifi, gorsel) VALUES(?, ?, ?, ?)"
                    val statement = database.compileStatement(sqlString)
                    statement.bindString(1, yemekIsmi)
                    statement.bindString(2, yemekMalzeme)
                    statement.bindString(3, yemekTarif)
